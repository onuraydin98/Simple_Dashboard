...
const PeopleList = ({ data, node_id, title }: ItemType): JSX.Element => {
	...
	return (
		<div id={node_id}>
			<div className="py-2 px-2 text-xl text-slate-200 text-center hmd:text-start">
				{title}
			</div>
			<div
				className={
					"grid grid-cols-3 gap-1 items-center mobile:grid-cols-2 hmd:w-fit hmd:max-h-[33vh] hmd:overflow-y-auto hmd:pr-4 py-5 hmd:py-0 xl:grid-cols-4 xl:gap-1 3xl:grid-cols-5"
				}
			>
